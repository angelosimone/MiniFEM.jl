...
- The strong form combines axial equilibrium, the constitutive relation, and
  essential and natural boundary conditions.
- The weak form is obtained by weighting the residual and integrating by parts,
  which lowers the regularity required of the displacement field.
- Essential boundary conditions define the admissible trial and test spaces;
  natural boundary conditions enter the load functional.
- A Galerkin finite element approximation replaces the infinite-dimensional
  trial and test spaces by finite-dimensional subspaces, typically with
  continuous piecewise-polynomial displacement fields.
:::

...
![Free-body representation of the idealised one-dimensional model, showing the spring end forces and their relation to the nodal forces, together with the reaction force $R$ and the applied force $F$.](images/cart-spring-model-free-body.png){
...
direction. The end labels $a$ and $b$ correspond to local nodes 1 and 2,
respectively.
